...
describe("Basic StringName function tests", () => {
  it("test insert", () => {
    ...
    let r: Name = n.insert(1, "cs");
    expect(r.asString()).toBe("oss.cs.fau.de");
  });
  it("test append", () => {
    let n: Name = new StringName("oss.cs.fau");
    let r: Name = n.append("de");
    expect(r.asString()).toBe("oss.cs.fau.de");
  });
  it("test remove", () => {
    let n: Name = new StringName("oss.cs.fau.de");
    let r: Name = n.remove(0);
    expect(r.asString()).toBe("cs.fau.de");
  });
});
...
describe("Escape character extravaganza", () => {
  it("test escape and delimiter boundary conditions", () => {
    ...
    let r: Name = n.append("people");
    expect(r.asString()).toBe("oss.cs.fau.de#people");
  });
